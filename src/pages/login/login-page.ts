...
export function LoginPage(): HTMLElement {
  ...
  createInput({ 
    attributes: {id: 'password', type: 'checkbox' }, 
    parent: passwordVisibilityWrapper,
  });
  ...
  createButton({
    ...
    classes: [...buttonStyles.general, 'cursor-pointer'],
  ...
  createA({ classes: ['cursor-pointer'], events: { click: () => console.log('clicked')}, parent: wrapper, text: "Don't have an account? Register" })
